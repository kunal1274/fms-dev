...
const Invoice = ({ goBack }) => {
  ...
  // Print setup using useReactToPrint hook
  ...
  // Update selected company when selection changes
  useEffect(() => {
  ...
  // Create an Axios instance for sales orders
  ...
  // Use jsPDF and html2canvas to generate and download a PDF of the invoice
  const downloadPDF = () => {
    ...
    html2canvas(invoiceElement, { scale: 2 })
      .then((canvas) => {
        ...
        // Create a new jsPDF instance with A4 dimensions (portrait)
  ...
  return (
    <div ref={componentRef} className="invoice-wrapper p-4" id="print-area">
      ...
      {/* Buttons for Print, Download PDF, and Go Back */}
