...
import CustomerPage from "./MainComponent/Customer/CustomerPage";
...
const items = [
  ...
  },
  {
    ...
    icon: <FaWarehouse />,
    description: "View and manage sale orders",
    page: PAGES.SALE,
  },
];
...
export default function ViewTogglePage() {
  ...
  const goBack = () => setCurrentPage(PAGES.DASHBOARD);

  // Render individual pages based on currentPage
  if (currentPage === PAGES.CUSTOMER) {
    return (
      <div className="p-6">
        <button
          onClick={goBack}
