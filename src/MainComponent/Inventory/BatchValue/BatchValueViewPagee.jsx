...
// const API_BASE = "https://fms-qkmw.onrender.com/fms/api/v0/Bins";
// const SITES_API = "https://fms-qkmw.onrender.com/fms/api/v0/sites";

// export default function BinViewPage({ BinId: propId, goBack }) {
//   // Determine ID from prop or URL
//   const { id: paramId } = useParams();
//   const BinId = propId || paramId;
...
//       setLoading(true);
//       try {
//         const resp = await axios.get(`${API_BASE}/${BinId}`);
...
//     if (!window.confirm("Are you sure you want to update this Bin?"))
//       return;
//     setLoading(true);
//     const toastId = toast.loading("Updating...");
//     try {
//       const resp = await axios.put(`${API_BASE}/${BinId}`, formData);
...
//         <h2 className="text-2xl font-semibold">Bin Details</h2>
