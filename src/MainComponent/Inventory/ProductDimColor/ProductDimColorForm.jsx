...
export default function ProductColor({ handleCancel }) {
  ...
  const apiBase = "https://fms-qkmw.onrender.com/fms/api/v0/ProductColors";
  ...
  const createProductColor = async (e) => {
    ...
    try {
      ...
      payload.append("ProductColorAddress", form.ProductColorAddress);
      ...
      toast.success("ProductColor created successfully");
      handleCancel();
    } catch (err) {
      console.error("Create error:", err.response || err);
      const msg = err.response?.data?.message || "Error creating ProductColor";
      toast.error(msg);
    }
  };
  ...
  return (
    <div className="p-4">
      <ToastContainer />
      <h3 className="text-xl font-semibold mb-4">ProductColor Form</h3>
      <form
        ...
        <section className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              value={form.name}
              onChange={handleChange}
              placeholder="e.g. Central ProductColor"
              required
              className="mt-1 w-full p-2 border rounded focus:ring-2 focus:ring-blue-200"
            />
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <input
              name="ProductColorAddress"
              value={form.ProductColorAddress}
              onChange={handleChange}
