...
// const API_BASE = "https://fms-qkmw.onrender.com/fms/api/v0/Zones";
// const SITES_API = "https://fms-qkmw.onrender.com/fms/api/v0/sites";

// export default function ZoneViewPage({ ZoneId: propId, goBack }) {
//   // Determine ID from prop or URL
//   const { id: paramId } = useParams();
//   const ZoneId = propId || paramId;
...
//       setLoading(true);
//       try {
//         const resp = await axios.get(`${API_BASE}/${ZoneId}`);
...
//     if (!window.confirm("Are you sure you want to update this Zone?"))
//       return;
//     setLoading(true);
//     const toastId = toast.loading("Updating...");
//     try {
//       const resp = await axios.put(`${API_BASE}/${ZoneId}`, formData);
