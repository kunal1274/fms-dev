...
// const API_BASE = "https://fms-qkmw.onrender.com/fms/api/v0/Rackss";
// const SITES_API = "https://fms-qkmw.onrender.com/fms/api/v0/sites";

// export default function RacksViewPage({ RacksId: propId, goBack }) {
//   // Determine ID from prop or URL
//   const { id: paramId } = useParams();
//   const RacksId = propId || paramId;
...
//       setLoading(true);
//       try {
//         const resp = await axios.get(`${API_BASE}/${RacksId}`);
...
//     if (!window.confirm("Are you sure you want to update this Racks?"))
//       return;
//     setLoading(true);
//     const toastId = toast.loading("Updating...");
//     try {
//       const resp = await axios.put(`${API_BASE}/${RacksId}`, formData);
...
//         <h2 className="text-2xl font-semibold">Racks Details</h2>
