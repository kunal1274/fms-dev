...
export default function Configuration({ handleCancel }) {
  const apiBase = "https://fms-qkmw.onrender.com/fms/api/v0/Configurations";
  ...
  const createProductConfiguration = async (e) => {
    e.preventDefault();
  ...
  return (
    <div className="p-4">
      <ToastContainer />
      <h3 className="text-xl font-semibold mb-4">Create New Configuration</h3>
      <form
        onSubmit={createProductConfiguration}
