...
export default function ProductStyle({ handleCancel }) {
  ...
  const createProductStyle = async (e) => {
    ...
    try {
      ...
      payload.append("ProductStyleAddress", form.ProductStyleAddress);
      ...
      const msg = err.response?.data?.message || "Error creating ProductStyle";
      toast.error(msg);
    }
  };
  return (
    <div className="p-4">
      <ToastContainer />
      <h3 className="text-xl font-semibold mb-4">ProductStyle Form</h3>
      <form
