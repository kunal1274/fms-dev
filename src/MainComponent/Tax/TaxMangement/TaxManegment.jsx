...
/** =========================================
 * IMPORTANT: Update these import paths
 * ========================================= */
...
export default function InventoryManagement() {
  ...
  // Map page keys to actual components
  const componentMap = useMemo(
    () => ({
      [PAGE.JOURNAL_LIST]: <JornalList />,
      [PAGE.JOURNAL_CREATE]: <Jornalcreation />,
      [PAGE.TAX_LIST]: <TaxList />,
    }),
    []
  );
  ...
  return (
    <div className="p-3 sm:p-4">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-semibold">Accounting and Tax </h2>
