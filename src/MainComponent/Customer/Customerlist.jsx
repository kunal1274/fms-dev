...
export default function CustomerList({ handleAddCustomer }) {
  ...
  const toggleSelectAll = (e) => {
    setSelectedIds(e.target.checked ? filteredCustomers.map(getId) : []);
  };
    ...
    <div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center space-x-2 ">
          <h3 className="text-xl font-semibold mb-6">Customer List</h3>
        </div>
      ...
      <div className="bg-white rounded-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4">
          {[
            ["Total Customers", summary.count],
            ["Credit Limit", summary.creditLimit],
            ["Paid Customers", summary.paidCustomers],
            ["Active Customers", summary.activeCustomers],
            ["On-Hold Customers", summary.onHoldCustomers],
          ].map(([label, value]) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <button
                      ...
                      onClick={() => handleCustomerClick(getId(c))}
                    >
                      {getCode(c)}
                    </button>
                  </td>
