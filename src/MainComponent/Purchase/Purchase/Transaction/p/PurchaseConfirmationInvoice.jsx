...
// Utility: Format number as currency (INR)
...
const PurchaseConfirmationInvoice = () => {
  ...
  return (
    <div className="p-6 text-sm text-gray-700">
      <h2 className="text-lg font-bold mb-4">Purchase Confirmation Invoice</h2>
      ...
      <section className="p-6 bg-white rounded Vendor">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {[
            {
              label: "Purchase Confirmation No.",
        ...
        <div className="max-h-96 overflow-y-auto mt-4 border rounded-lg bg-white">
          <div className="space-y-6 p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 bg-gray-50 p-4 rounded-lg">
              <SummaryCard label="Advance" value={formatCurrency(advance)} />
              <SummaryCard
                label="Subtotal / Line Amount"
                value={formatCurrency(amountBeforeTax)}
              />
              <SummaryCard label="Total Discount" value={`${discount}%`} />
              <SummaryCard
                label="Total Tax"
              ...
              <SummaryCard
                label="Total TDS/TCS"
                value={formatCurrency(tcsAmount)}
              />
              <SummaryCard
                label="Grand Total"
...
export default PurchaseConfirmationInvoice;
