      ...
      <form onSubmit={handleCreate} className="bg-white rounded-lg">
        ...
        <section className="p-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-gray-50 p-4 rounded-lg">
            ...
            <SummaryCard label="  Order_ID " value="  Order ID" />
            <SummaryCard label="Invoice_Date  " value="101" />
            <SummaryCard label="Total Amount" value="INV-2025-01" />
            <SummaryCard label="Approval Amount" value="2025-07-03" />
          </div>
        </section>
