...
import { useCreatePurchaseOrderMutation, useUpdatePurchaseOrderMutation } from '../../store/api'
import type { PurchaseOrder, OrderStatus, Currency, PaymentTerms } from '../../types/models'
...
const PurchaseOrderForm: React.FC<PurchaseOrderFormProps> = ({ order, onSuccess, onCancel }) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <FormGroup>
        ...
        <FormRow>
          ...
          <FormField label="Vendor Code" error={errors.vendorCode?.message} required>
            <Input
              {...register('vendorCode')}
        ...
        <FormRow>
          <FormField label="Expected Delivery Date" error={errors.expectedDeliveryDate?.message}>
            <Input
              type="date"
