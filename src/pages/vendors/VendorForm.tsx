...
import { useCreateVendorMutation, useUpdateVendorMutation } from '../../store/api'
import type { Vendor, BusinessType, Currency, PaymentTerms, VendorStatus } from '../../types/models'
  ...
  useEffect(() => {
    if (vendor) {
      reset({
        ...
        bankDetails: vendor.bankDetails?.length ? vendor.bankDetails : [
          {
            bankName: '',
            accountNumber: '',
            accountHolderName: '',
